 ...
 */
class CRM_SolImport_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_SolImport_Upgrader(
        'nl.schreeuwomleven.import',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_SolImport_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
  ...
  public function onInstall() {
    echo $this->extensionDir . '/sql/*_install.sql'."\n";
